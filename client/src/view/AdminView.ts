import {IEntity, IRepository} from '../model/Repository';
...
export class AdminView {
    ...
    constructor(public element: HTMLElement, public options: IAdminViewOptions, public moveVIew: MovementView) {
    ...
    private buildTable(type: string, repository: IRepository): string {
      ...
      <tbody>
        ${entities.reduce((acc, entity) => {
            return acc + this.buildTableRow(type, entity)
        }, '')}
      </tbody>
    </table>`);
    }
